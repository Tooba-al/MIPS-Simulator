...
public class TestMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //2 50 64 32
        FileOutputStream output = new FileOutputStream("/home/ali/Desktop/mipsjava/out/production/mipsjava/mips/test.txt");
        output.write(b);
        output.close();
        // create a new input stream
        FileInputStream input = new FileInputStream("/home/ali/Desktop/mipsjava/out/production/mipsjava/mips/test.txt");
