...
//			memory.add(word);
        ...
        c = (((long) 0b10001100) << 24) + (((long) 0b00000001) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00010000);
		memory.add(new Long(c));
        c = (((long) 0b10001100) << 24) + (((long) 0b00000010) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00010100);
		memory.add(new Long(c));
        c = (((long) 0b10001100) << 24) + (((long) 0b00000011) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00011000);
		memory.add(new Long(c));
        c = (((long) 0b00001000) << 24) + (((long) 0b00000000) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00000111);
		memory.add(new Long(c));
        c = (((long) 0b00000000) << 24) + (((long) 0b00000000) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00001000);
		memory.add(new Long(c));
        c = (((long) 0b00000000) << 24) + (((long) 0b00000000) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00000010);
		memory.add(new Long(c));
        c = (((long) 0b00000000) << 24) + (((long) 0b00000000) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00000011);
		memory.add(new Long(c));
        c = (((long) 0b00000000) << 24) + (((long) 0b00100010) << 16) + (((long) 0b00100000) << 8) + ((long) 0b00100000);
		memory.add(new Long(c));
        c = (((long) 0b00000000) << 24) + (((long) 0b10000011) << 16) + (((long) 0b00101000) << 8) + ((long) 0b00100010);
		memory.add(new Long(c));
        c = (((long) 0b11111100) << 24) + (((long) 0b00000000) << 16) + (((long) 0b00000000) << 8) + ((long) 0b00000000);
		memory.add(new Long(c));
	}
